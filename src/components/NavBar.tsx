...
export default function NavBar({ user }: NavBarProps) {
  ...
  return (
    <nav style={{ backgroundColor: 'var(--tg-theme-bg-color)' }} className="border-t border-gray-200 dark:border-gray-700 fixed bottom-0 left-0 right-0 z-50">
      <div className="flex justify-around items-center h-14 max-w-lg mx-auto">
        ...
        {isAdmin && (
          <Link
            ...
            style={{ color: pathname.startsWith('/admin') ? 'var(--tg-theme-button-color)' : 'var(--tg-theme-hint-color)' }}
          >
